        ...
        <div x-show="menuWishlist"
            ...
            <div>
                <a href="#" class="flex gap-3 p-4 pb-2">
                    <img src="{{ asset('/assets/images/header/deseo/deseo1.jpg') }}" alt="" class="h-16 w-16 object-cover">
                    <div>
            ...
            <div>
                <a href="#" class="flex gap-3 p-4 pb-2">
                    <img src="{{ asset('/assets/images/header/deseo/deseo2.jpg') }}" alt="" class="h-16 w-16 object-cover">
                    <div>
                        <p class="font-semibold leading-tight line-clamp-2">
                            {{ fake()->sentence }}
                        </p>
