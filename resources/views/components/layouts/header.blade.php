<header class="py-3 px-6 flex items-center flex-wrap gap-6 text-sm">
    ...
    <div x-data="{ menuWishlist: false }" class="relative" @click.away="menuWishlist = false">
        <svg @mouseover="menuWishlist = true" @click="menuWishlist = ! menuWishlist"
            ...
            stroke="currentColor" class="w-6 h-6 hover:text-udemy hover:cursor-pointer">
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
        </svg>

        <div x-show="menuWishlist"
            class="absolute mt-8 right-0 w-[300px] border border-gray-300 divide-y divide-gray-300">
            <div>
    ...
    <div x-data="{ menuCart: false }" class="relative" @click.away="menuCart = false">
        <div class="relative">
            <svg @mouseover="menuCart = true" @click="menuCart = ! menuCart" xmlns="http://www.w3.org/2000/svg"
        ...
        <div x-show="menuCart"
            ...
            <div class="p-4 ">
                ...
                <a href="#"
                    class="block mt-2 p-4 bg-primary hover:bg-primary-light text-white text-base text-center">
                    Ir a la cesta
                </a>
            </div>
        </div>
